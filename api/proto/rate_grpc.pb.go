...
const (
	RateService_GetRates_FullMethodName    = "/proto.RateService/GetRates"
	RateService_HealthCheck_FullMethodName = "/proto.RateService/HealthCheck"
)
